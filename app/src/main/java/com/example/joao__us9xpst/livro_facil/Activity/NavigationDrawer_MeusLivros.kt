...
class NavigationDrawer_MeusLivros : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val itemClickListener = object  : AdapterView.OnItemClickListener{
            override fun onItemClick(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                val i = Intent(this@NavigationDrawer_MeusLivros, LivroDetalhes_Edit::class.java)
    ...
    private fun initLivros() {
        val menuListener = object : ChildEventListener {
            ...
            override fun onChildAdded(ds: DataSnapshot, p1: String?) {
                ...
                if(livro.user.id == UserUtil.getUser().id ){
        ...
        //Livro.livroRef.orderByChild("user")
            //.equalTo(UserUtil.getUser().id,"id" ).addChildEventListener(menuListener);
    }
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.nav_donate -> {
                val i = Intent(this@NavigationDrawer_MeusLivros, CadastroLivro::class.java)
                startActivity(i)
            }
            R.id.nav_meusLivros -> {
    ...
    fun logout() {
        ...
        finish()
        val i = Intent(this@NavigationDrawer_MeusLivros, FacebookLogin::class.java)
        startActivity(i)
    }
}
